...
namespace ConsoleApp.Tests
{
    ...
    public class SelectJoinTest
    {
        ...
        private int GetPossibleId()
        {
            int possibleId = numbers.FindIndex(x => x == index);
            Console.WriteLine("at list: " + numbers.IndexOf(index));
            index++;
            return possibleId;
        }
        ...
        public void DP_Select_Student_By_Id_With_Courses_RawSqwl()
        {


            // Console.WriteLine("*** Test");
            Console.WriteLine( "Possible id: " + GetPossibleId());
            // int id = GetRandomId();
            //
            //
            //
            ...
            //                         JOIN course c ON
	           //                          c.id = cs.CoursesId
            //                         WHERE
	           //                          s.id = {0} ", GetPossibleId()).SingleOrDefaultAsync();
        }
